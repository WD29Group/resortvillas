...
function Parallax() {
  return (
    <>
        <div class="bgimg-1">
          <div class="caption">
          <span class="border">Resort Villas</span>
        </div>
        </div>
        ...
        <div class="bgimg-2">
          <div class="caption">
          <span class="border" style={{backgroundColor: "transparent", fontSize: "25px", color: "#f7f7f7"}}>El Nido Beach Hotels</span>
          </div>
        </div>
        ...
        <div class="bgimg-3">
          <div class="caption">
          <span class="border" style={{backgroundColor: "transparent", fontSize: "25px", color: "#f7f7f7"}}>Visti new places you've never been before</span>
          </div>
        </div>
        ...
        <div class="bgimg-1">
          <div class="caption">
          <span class="border">Resort Villa at your service</span>
          </div>
        </div>
    </>
  );
